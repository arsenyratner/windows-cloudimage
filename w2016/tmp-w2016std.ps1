...
$switchName = 'VM'
$windowsImagePath = "C:\vm\w2016std-image.qcow2"
$wimFilePath = "D:\pub\iso\Microsoft\Windows Server 2016 10.0.14393\9327751\sources\install.wim"
...
$extraDriversPath = "$scriptPath\drivers\"
$extraPackages = "D:\pub\Install\updates\2016\windows10.0-kb4103720-x64.cab"
...
Set-IniFileValue -Path $configFilePath -Section "Default" -Key "extra_packages" -Value $extraPackages
