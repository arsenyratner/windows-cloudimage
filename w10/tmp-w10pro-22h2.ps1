...
$switchName = 'VM'
$wim_file_path = "D:\Users\Public\iso\Microsoft\w10-22h2-202501-install.wim"
$wim_ImageIndex = 5
...
Set-IniFileValue -Path $configFilePath -Section "Default" -Key "enable_shutdown_without_logon" -Value "False"
